...
final class WordTable extends Entity\DataManager implements \Serializable
{
	...
	{
		if(Helper::checkIndexNameExists('IX_SALE_LOC_SEARCH_WORD_TMP', static::getTableName()))
			Main\HttpApplication::getConnection()->query("drop index IX_SALE_LOC_SEARCH_WORD_TMP on ".static::getTableName());
